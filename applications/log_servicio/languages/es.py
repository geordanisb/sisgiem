...
'Enter date as %(format)s': 'Entre un fecha como %(format)s',
'Enter date in range %(min)s %(max)s': 'Entre una fecha en rango %(min)s %(max)s',
...
'Valadq': 'Valadq',
'Valcont': 'Valcont',
'Valor requerido': 'Valor requerido',
